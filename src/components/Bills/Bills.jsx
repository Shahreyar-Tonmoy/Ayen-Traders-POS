  ...
  const handleDelete = (_id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axiosPublic
          .delete(`/api/billingitems/delete/one/${_id}`)
          .then((res) => {
            if (res.data.status === 200) {
    ...
    <div>
      ...
      {data?.length > 0 ? (
                      ...
                      <tr className="px-5 " key={idx}>
                        ...
                        <td className="p-2">
                          <div className="flex justify-center">
                            <button
                              onClick={() => handleDelete(billingItem?._id)}
                            >
                              <svg
                ...
                <div>
                  <button
                    ...
                    className={`rounded-sm ${
                      data?.length === 0
                        ? "hidden"
                        : "bg-transparent border-[#001529] text-black  hover:text-white hover:bg-[#001529]"
                    } text-base text-black btn`}
                  >
                    Make Invoice
                  </button>
                  <div
                    ...
                    >
                      ...
                      <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="flex mt-5 justify-between">
                          <button className="me-2 rounded-md btn-sm bg-green-700  text-white text-base">
                            Submit
                          </button>
                        </div>
                      </form>
        ...
        <div className="flex flex-col items-center h-[80vh]  justify-center">
          <h1 className="lg:text-5xl text-2xl text-red-500">
            There is no pendding bill here
          </h1>
          <div></div>
        </div>
      )}
